...
import { TipoElemento } from './DoItYourselfV3App';
import { Departamento } from '@/mocks/do-it-yourself-v2';
...
interface FilterPanelProps {
  ...
  modoSprint: boolean;
  setModoSprint: (modo: boolean) => void;
}
          ...
          <div className="w-48">
            ...
            <div className="flex items-center space-x-3">
              <input
                ...
                onChange={(e) => {
                  // Usar requestAnimationFrame para que el cambio se aplique
                  // después del ciclo de renderizado actual
                  const value = parseInt(e.target.value);
                  if (!isNaN(value) && value >= 0 && value <= 50) {
                    // Usar setTimeout con 0ms para desacoplar la actualización
                    // del flujo de renderizado principal
                    setTimeout(() => {
