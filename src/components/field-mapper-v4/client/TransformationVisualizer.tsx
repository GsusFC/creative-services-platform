...
import { getTransformation, Transformation } from '@/lib/field-mapper-v4/transformations';
...
export default function TransformationVisualizer({
  ...
  const [sourceValue, setSourceValue] = useState<unknown>(null);
      ...
      <div className="flex flex-col space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="w-2/5">
            ...
            <div className="p-3 bg-teal-100 rounded text-sm overflow-hidden">
