        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <Link href="/admin/system-tools" className="block group">
              <Card className="bg-gradient-to-br from-gray-900/90 to-gray-950/95 border border-white/10 hover:border-indigo-500/50 hover:bg-gray-900/80 transition-all duration-300 shadow-xl h-full">
                <CardHeader className="pb-4 border-b border-white/5 bg-black/20">
                  <CardTitle className="flex items-center gap-3 text-xl text-white group-hover:text-indigo-400 transition-colors">
                    <div className="p-2 bg-indigo-500/20 rounded-lg">
                      <WrenchIcon className="h-5 w-5 text-indigo-400" />
                    </div>
                    Herramientas del Sistema
                  </CardTitle>
                  <CardDescription className="text-gray-400">
                    Pruebas de tipografía y utilidades de desarrollo
                  </CardDescription>
                </CardHeader>
                <CardContent className="pt-6">
                  <ul className="text-gray-300 space-y-3 mb-8">
                    <li className="flex items-center gap-2 text-sm">
                      ...
                      Pruebas de tipografía y fuentes
                    </li>
                    <li className="flex items-center gap-2 text-sm">
                      <div className="w-1.5 h-1.5 rounded-full bg-indigo-500"></div>
                    ...
                    <li className="flex items-center gap-2 text-sm">
                      <div className="w-1.5 h-1.5 rounded-full bg-indigo-500"></div>
                      Estructura de estilos dividida
                    </li>
                  </ul>
                  <div className="flex justify-end">
                    <div className="flex items-center gap-2 text-indigo-400 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-0 group-hover:translate-x-1">
