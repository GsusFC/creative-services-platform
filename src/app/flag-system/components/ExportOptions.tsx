    ...
    <div className="bg-black border-t border-gray-800">
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          ...
          className="px-4 py-2 bg-black hover:bg-gray-900 text-white border transition-colors flex items-center justify-center" style={{ borderColor: '#00FF00' }}
      ...
      {isExporting && (
        <div className="mt-4 p-2 bg-green-900/20 border border-green-700/30 text-green-400 text-sm flex items-center">
